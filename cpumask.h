...
#define cpu_lp_mask 	  ((const struct cpumask *const)&cpu_lp_mask)
#define cpu_perf_mask 	  ((const struct cpumask *const)&cpu_perf_mask)
#define cpu_perfp_mask 	  ((const struct cpumask *const)&cpu_perfp_mask)
